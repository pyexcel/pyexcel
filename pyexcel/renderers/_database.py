...
class SQLAlchemyRenderer(Renderer):
    ...
    def render_sheet_to_stream(self, file_stream, sheet, init=None, mapdict=None,
                               **keywords):
    ...
    def render_book_to_stream(self, file_stream, book, inits=None, mapdicts=None, **keywords):
