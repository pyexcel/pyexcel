...
.. table:: a map of plugins and supported excel file formats
   ...
   `text`_   json, rst, mediawiki,latex, grid, etc. tabulate      2.6, 2.7, 3.3, 3.4, pypy writing to files only
   ========= ====================================== ============= ======================== =============================
...
.. table:: Plugin compatibility table
    ...
    ======= ========== =========== ============ ============ ============ ============
    v0.1.8  0.0.6      0.0.7       0.0.6        0.0.6+       0.0.8        0.0.3
    v0.1.7  0.0.6      0.0.7       0.0.6        0.0.6+       0.0.8        0.0.3
    v0.1.6  0.0.5      0.0.7       0.0.6        0.0.6+       0.0.8        0.0.3
